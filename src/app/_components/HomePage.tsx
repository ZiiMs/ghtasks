	...
	return (
		<div className="flex h-screen w-full flex-col items-center justify-center gap-4">
			<button
				...
				className="flex max-w-fit flex-row items-center gap-1 rounded-md bg-white px-2 py-1 font-semibold text-gray-900 hover:bg-gray-100 active:scale-95 active:bg-gray-100"
			>
				<FaGithub />
				Sign in with Github
			</button>
	...
	return (
		<div className="flex flex-col gap-4">
			...
			<Link href={"/repo/new"} passHref className="flex">
				<button
					type="button"
					className="group relative flex items-center justify-center gap-1 rounded-md bg-slate-900 p-2 hover:cursor-pointer hover:bg-opacity-60 focus:ring-2 focus:ring-red-500"
				>
